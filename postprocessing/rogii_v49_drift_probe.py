# ===== v49 = v40 stack + signed-drift ramp probe DELTA=+1.5 =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v49 = v40 stack + signed-drift ramp probe DELTA=+1.5)')
...
import numpy as np, pandas as pd
DELTA = +1.5          # ft at toe; flip sign or rescale for the follow-up probe
