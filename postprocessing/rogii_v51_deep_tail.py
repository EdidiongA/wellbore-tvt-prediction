# ===== v51 = v40 stack + drift ramp DELTA=-3.0 (deep-tail probe) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v51 = v40 stack + drift ramp DELTA=-3.0 (deep-tail probe))')
...
import numpy as np, pandas as pd
DELTA = -3.0          # deep-tail probe; edit to -2.5 for the conservative variant
