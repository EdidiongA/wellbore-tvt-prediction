# ===== v48 = line-damper S=0.15 + flat HF h=0.46 W1201 (max width) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v48 = line-damper S=0.15 + flat HF h=0.46 W1201 (max width))')
