# ===== v44: SHAPE combo -- line-damp + HF shrink RAMPED along the well
...
S_LINE, P0 = 0.15, 0.40
H_HEEL, H_TOE, WIN_MID = 0.30, 0.65, 601
H_FINE, WIN_FINE = 0.20, 151
...
print('submission.csv rewritten (v44 shape combo)')
