# ===== v57 = full stack + CUBIC profile, transverse dose -2.7 (valley cross-section; -2.4 -> 8.720) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v57 = full stack + CUBIC profile, transverse dose -2.7 (valley cross-section; -2.4 -> 8.720))')
...
import numpy as np, pandas as pd
DELTA = -2.7          # transverse dose probe at p=3 (valley cross-section)  # was: two independent
