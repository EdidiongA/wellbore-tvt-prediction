# ===== v51 = v40 stack + drift ramp DELTA=-1.0 (V-vs-quadratic discriminator) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v51 = v40 stack + drift ramp DELTA=-1.0 (V-vs-quadratic discriminator))')
...
import numpy as np, pandas as pd
DELTA = -1.0          # ft at toe; flip sign or rescale for the follow-up probe
