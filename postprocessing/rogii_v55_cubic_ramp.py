# ===== v55 = full stack + CUBIC drift profile (toe -2.4, projection-matched; p-axis: 1->8.730, 2->8.722) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v55 = full stack + CUBIC drift profile (toe -2.4, projection-matched; p-axis: 1->8.730, 2->8.722))')
