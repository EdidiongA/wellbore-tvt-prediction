# ===== v41 = v28 line-damper (P0=0.40 S=0.15) + flat HF h=0.60 W901 (bold dose) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v41 = v28 line-damper (P0=0.40 S=0.15) + flat HF h=0.60 W901 (bold dose))')
