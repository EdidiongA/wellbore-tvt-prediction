# ===== v36: PURIFIED v28 -- +w*(Z-L_Z)_low at the toe, structural term removed =====
# v28 = w*(L_u-u) [harmful, v31] + w*(Z-L_Z) [beneficial]. This ships only the
# beneficial wellbore term, low-frequency, dose bumped 0.15 -> 0.20.
W_TOE, RAMP_P0, CAP = 0.20, 0.40, 30.0
H_HF, WIN_HF = 0.0, 601
TAG='v36 steering-only w=0.20 full-band CAP=30'
