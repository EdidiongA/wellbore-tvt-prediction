# ===== v46 = line-damper S=0.25 + flat HF h=0.40 W601 (S-axis under strong HF) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v46 = line-damper S=0.25 + flat HF h=0.40 W601 (S-axis under strong HF))')
