# ===== v53 = v40 stack + per-foot drift at 2x rate (-3.0/4800 per station) =====
...
sub[['id', 'tvt']].to_csv('submission.csv', index=False)
print('submission.csv rewritten (v53 = v40 stack + per-foot drift at 2x rate (-3.0/4800 per station))')
...
import numpy as np, pandas as pd
RATE = -3.0 / 4800.0   # 2x rate: dose ladder on the per-foot axis
                        # (median toe dose -3.0; rate axis: 0 -> 8.772, 1x -> 8.471)
